...
AS
BEGIN
	INSERT INTO Beer ([name], [description], degree, [type]) OUTPUT inserted.Id VALUES (@Name, @Description, @Degree, @Type)
END
GO
...
AS
BEGIN
	INSERT INTO Brand ([name], company_name) OUTPUT inserted.Id VALUES (@Name, @CompanyName)
END
GO
...
AS
BEGIN
	INSERT INTO Ingredient ([name]) OUTPUT inserted.Id VALUES (@Name)
END
GO
...
AS
BEGIN
	UPDATE Beer set [name] = @Name, [description] = @Description, degree = @Degree, [type] = @Type WHERE Id = @Id
END
GO
...
AS
BEGIN
	UPDATE Brand SET [name] = @Name, company_name = @CompanyName WHERE Id = @Id
END
GO
