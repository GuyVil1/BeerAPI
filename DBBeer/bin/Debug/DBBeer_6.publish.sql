...
AS
BEGIN
	INSERT INTO Beer ([name], degree, [type]) OUTPUT inserted.Id VALUES (@Name, @Degree, @Type)
END
GO
...
BEGIN
	SELECT * FROM Beer 
	LEFT JOIN Brand ON Beer.brand_id = Brand.Id
END
GO
...
INSERT INTO Beer (name, degree, type, brand_id)
